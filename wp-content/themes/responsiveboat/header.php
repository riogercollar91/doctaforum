...
<!-- menu idioma aki -->
						<!-- <ul id="menu-idioma" class="nav navbar-nav navbar-right responsive-nav main-nav-list">
						<li id="menu-es" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home"><a href="http://www.doctaforum.com/#footer">Es</a></li>
						<li id="menu-en" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home"><a href="http://www.doctaforum.com/#footer">En</a></li>
						<li id="menu-ca" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home"><a href="http://www.doctaforum.com/#footer">Ca</a></li>
						</ul> -->
						<?php 

...
function jquery_counterup_custom_script_fix1()
{
	wp_enqueue_script('jquery_counterup-script', get_stylesheet_directory_uri() . '/js/jquery.counterup.js', array(), true);
}
add_action( 'wp_enqueue_scripts', 'jquery_counterup_custom_script_fix1' );
